...
<div class="fancybox2" style="display: none">ddddddddd</div>
	...
	<script type="text/javascript">
		$(".flexme3").flexigrid({
			...
			dataType : 'xml',
			colModel : [ 
				{ display : 'ลำดับ', name : 'TYPEID', width : 40, sortable : true, align : 'center' }, 
				{ display : 'ชื่อประเภท', name : 'TYPENAME', width : 180, sortable : true, align : 'left' }, 
				{ display : 'คำอธิบาย', name : 'DESCRIPTION', width : 120, sortable : true, align : 'left' }, 
			...
			searchitems : [ 
				{ display : 'ลำดับ', name : 'TYPEID'}, 
				{ display : 'ชื่อประเภท', name : 'TYPENAME', isdefault : true}
			],
			sortname : "TYPEID",
			sortorder : "desc",
			usepager : true,
