...
$sortname = isset($_POST['sortname']) ? $_POST['sortname'] : 'typeid';
...
foreach($rows AS $row){
	$xml .= "<row id='".$row['TYPEID']."'>";
	$xml .= "<cell><![CDATA[".$row['TYPEID']."]]></cell>";
	$xml .= "<cell><![CDATA[".$row['TYPENAME']."]]></cell>";
