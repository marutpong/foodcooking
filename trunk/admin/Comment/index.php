...
<body>
<h2>Comment</h2>
<div class="fancybox2" style="display: none">Comment</div>
	...
	<script type="text/javascript">
		$(".flexme3").flexigrid({
			...
			dataType : 'xml',
			colModel : [ 
				{ display : 'USer ID', name : 'UIDS', width : 130, sortable : true, align : 'center' }, 
				{ display : 'Food ID', name : 'FID', width : 130, sortable : true, align : 'left', },
				{ display : 'Message', name : 'MESSAGE', width : 130, sortable : true, align : 'left', }, 
				{ display : 'Time', name : 'STIME', width : 130, sortable : true, align : 'left', } 
			],
			buttons : [ 
			...
			searchitems : [ 
				{ display : 'USer ID', name : 'UIDS', isdefault : true}, 
				{ display : 'Food ID', name : 'FID'},
				{ display : 'MESSAGE', name : 'MESSAGE'},
				{ display : 'วันที่', name : 'STIME'}
			],
			sortname : "UIDS",
			sortorder : "desc",
			usepager : true,
