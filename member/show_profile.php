...
?>
	...
	<footer><center>
        <input type="button" class="button_addmore" onclick="location.href='edit_profile.php'" value="Edit Profile">
        <input type="button" class="button_addmore" onclick="location.href='change_pass.php'" value="Change Password">
        </center>
	</footer>
</form>
</body>
